...
mysqli_query($conn, "insert into meeting(title,roomid,meetfile,numattend,head,end,start,roomname) values('$title','$roomid','$meetfilelocation','$numattend','$head','$end','$start','$roomname')");
